      ...
      <div className="max-w-4xl w-full mx-auto my-auto py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            ...
            className="p-7 rounded-3xl bg-[#0C1427] border border-[#182643] hover:border-blue-500 hover:bg-[#111d38] transition-all cursor-pointer group shadow-2xl flex flex-col justify-between space-y-6 relative overflow-hidden"
          >
            <div className="space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-blue-600/20 border border-blue-500/40 flex items-center justify-center text-blue-400 shadow-md group-hover:scale-110 transition-transform">
            ...
            <div className="pt-4 border-t border-[#182643] flex items-center justify-between text-xs font-bold text-blue-400 group-hover:translate-x-1 transition-transform">
          ...
          <div
            ...
            className="p-7 rounded-3xl bg-[#0C1427] border border-[#182643] hover:border-emerald-500 hover:bg-[#112328] transition-all cursor-pointer group shadow-2xl flex flex-col justify-between space-y-6 relative overflow-hidden"
          >
            <div className="space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-emerald-600/20 border border-emerald-500/40 flex items-center justify-center text-emerald-400 shadow-md group-hover:scale-110 transition-transform">
            ...
            <div className="pt-4 border-t border-[#182643] flex items-center justify-between text-xs font-bold text-emerald-400 group-hover:translate-x-1 transition-transform">
